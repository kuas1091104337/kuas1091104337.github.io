import{_ as t,g as n}from"./index-CNwOqUnJ.js";const i={};function s(a,e){return e[0]||(e[0]=n(`<h3 class="interview__title">杏遠科技有限公司 - 前端考題</h3><p class="interview__text">1.請寫出執行結果</p><pre class="interview__code">var abc1=&#39;123&#39;;
function show(){
  var abc2=&#39;456&#39;; 
  alert(abc1+&#39; &amp; &#39;+abc2);
}
...
&lt;div&gt;
  ...
  &lt;/label&gt;
&lt;/div&gt;
</pre><p class="interview__example"></p><p class="interview__text">5.請簡單說明您對 vuex 的理解，包含 vuex 的使用時機與，vuex 中 store, mutations, getters, actions, 與 modules 的作用</p><p class="interview__ans">ANS:</p><p class="interview__example"><span class="interview__example_txt">Vuex 是狀態管理模式，用於集中管理應用中的共享狀態。提供全局存儲(store)，讓組件之間可以高效地共享數據，並解決多個組件需要共同管理狀態的問題。</span><span class="interview__example_txt">使用時機：</span><span class="interview__example_txt">1. 多個組件需要共享狀態時，例如用戶認證資訊、購物車數據等。</span><span class="interview__example_txt">2. 需要跨組件通信時，使用父子通信(rops和emit，可以避免透過props和事件逐層傳遞數據，從而簡化狀態管理)或兄弟組件通信(事件總線)的代碼難以維護時。</span><span class="interview__example_txt">3. 應用較為複雜，需要集中管理狀態時，讓狀態變化透明化，可以追踪每一次狀態的變更，方便調試(提供了 Actions 和 Mutations，可以將狀態的更新邏輯集中管理。)。</span><span class="interview__example_txt">4. 需要持久化某些狀態時</span><span class="interview__example_txt">State(狀態)：儲存應用的狀態數據，是唯一的數據源，是響應式的，不能直接修改，必須通過 mutations。</span><span class="interview__example_txt">Mutations(變更)：用於修改 state，必須是同步函數，通過 commit 觸發，第1個參數是 state，第2個是 commit傳入的第2個參數。</span><span class="interview__example_txt">Actions(動作)：可以包含異步操作，通過 dispatch 觸發，不能直接修改 state，需要通過 commit 觸發 mutations 來修改狀態，可以包含複雜的業務邏輯。</span><span class="interview__example_txt">Getters(獲取器)可以認為是 store 的計算屬性，可以對 state 進行加工，可以接收其他 getters 作為第二個參數，結果會被緩存。</span><span class="interview__example_txt">Modules(模塊)：用於將 store 分割成模塊，每個模塊可以有自己的 state、mutations、actions、getters，可以通過 namespaced 實現命名空間隔離，有助於管理大型應用的狀態。(模塊化+命名空間，目得讓代碼更好維護，讓多種數據分類更加明確)</span><span class="interview__example_txt">開啟命名空間後，組件中讀取state資料：</span><span class="interview__example_txt">方式1 自己直接讀取：<i class="interview__example__note">this.$store.state.personAbout.list</i></span><span class="interview__example_txt">方式2 透過mapState讀取：<i class="interview__example__note">...mapState(&#39;countAbout&#39;,[&#39;sum&#39;,&#39;school&#39;,&#39;subject&#39;])</i></span><span class="interview__example_txt"></span><span class="interview__example_txt">開啟命名空間後，組件中讀取getters資料：</span><span class="interview__example_txt">方式1 自己直接讀取：<i class="interview__example__note">this.$store-getters[&#39;personAbout/firstPersonName&#39;]</i></span><span class="interview__example_txt">方式2 借助mapGetters讀取：<i class="interview__example__note">...mapGetters(&#39;countAbout&#39;,[&#39;bigsum&#39;])</i></span><span class="interview__example_txt"></span><span class="interview__example_txt">開啟命名空間後，組件中調用dispatch：</span><span class="interview__example_txt">方式1 自己直接dispatch：<i class="interview__example__note">this.$store.dispatch(&#39;personAbout/addPersonWang&#39;,person)</i></span><span class="interview__example_txt">方式2 借助mapActions：<i class="interview__example__note">...mapActions(&#39;countAbout&#39;,{incrementOdd:&#39;jiaOdd&#39;,incrementWait:&#39;jiaWait&#39;})</i></span><span class="interview__example_txt"></span><span class="interview__example_txt">開啟命名空間後，組件中調用commit：</span><span class="interview__example_txt">方式1 自己直接commit：<i class="interview__example__note">this.$store.commit(&#39;personAbout/ADD_PERSON&#39;,person)</i></span><span class="interview__example_txt">方式2 借助mapMutations：<i class="interview__example__note">...mapMutations(&#39;countAbout&#39;,{increment:&#39;JIA&#39;,decrement:&#39;JIAN&#39;})</i></span><span class="interview__example_txt">最佳實踐：</span><span class="interview__example_txt"> 1. 合理劃分模塊</span><span class="interview__example_txt"> 2. 保持 mutations 簡單純粹</span><span class="interview__example_txt"> 3. 複雜邏輯放在 actions</span><span class="interview__example_txt"> 4. 善用 getters 處理數據</span></p><pre class="interview__code">import { createStore } from &quot;vuex&quot;;
